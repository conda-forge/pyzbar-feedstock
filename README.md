About pyzbar-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyzbar-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9777&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyzbar-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyzbar` can be installed with `conda`:
...
It is possible to list all of the versions of `pyzbar` available on your platform with `conda`:
...
```
mamba search pyzbar --channel conda-forge
```
...
mamba repoquery search pyzbar --channel conda-forge

# List packages depending on `pyzbar`:
mamba repoquery whoneeds pyzbar --channel conda-forge

# List dependencies of `pyzbar`:
mamba repoquery depends pyzbar --channel conda-forge
```
